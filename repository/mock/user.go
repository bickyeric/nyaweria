...
func (m *MockUser) GetByUsername(ctx context.Context, username string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) GetByUsername(ctx, username any) *gomock.Call {
